...
public class Vehicle {
    ...
    public void adjustForBurn(int burnAmount) {
        ...
        // subtract speed from Altitude : speed = distance / time
        Altitude -= Velocity;
    ...
    public DescentEvent getStatus(int tick) {
        // create a return of a new DescentEvent object
        DescentEvent obj = new DescentEvent(tick,Velocity,Fuel, Altitude, Flying);
